...
$sql = "SELECT * FROM job WHERE minimum_10marks<='$marks10' and minimum_12marks<='$marks12' and minimum_cpi<='$cpi'";
$result = $conn->query($sql);
                            ...
                            <table id="filter" class="table">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr><td>" . $row['name'] . "</td><td>" . $row['sector'] . "</td><td>" . $row['salary'] . "</td><td><a href=\"apply.php\" onclick=\"event.preventDefault(); document.getElementById('cid').value='" . $row['cid'] . "'; document.getElementById('role').value='" . $row['sector'] . "'; document.getElementById('form').submit();\">View</a></td></tr>";
                                    } ?>
