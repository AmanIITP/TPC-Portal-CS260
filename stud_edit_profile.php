    ...
    <div class='container'>
        <div class='panel panel-primary dialog-panel'>
            ...
            <div class='panel-body'>
                <form action="stud_update_data.php" method="post" class='form-horizontal' role='form'>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-8'>
                            <div class='col-md-3 indent-small'>
                                <div class='form-group internal'>
                                    <input class='form-control' name='interest' placeholder='Interest' type='text' required>
                                </div>
                            </div>
                        </div>
                    </div>
