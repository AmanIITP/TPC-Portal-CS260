                        ...
                        <div class="card-body">
                            ...
                            <table id="filter" class="table">
                                ...
                                <?php while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr><td>" . $row['roll_no'] . "</td><td>" . $row['name'] . "</td><td>" . $row['interest'] . "</td><td><a href=\"detail.php\" onclick=\"document.getElementById('roll_no').value='" . $row['roll_no'] . "'; document.getElementById('form').submit();\">View</a></td></tr>";} ?>
